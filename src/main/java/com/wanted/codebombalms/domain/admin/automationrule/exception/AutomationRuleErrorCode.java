package com.wanted.codebombalms.domain.admin.automationrule.exception;
...
public enum AutomationRuleErrorCode implements ErrorCode {
    ...
    INVALID_THRESHOLD_VALUE(400, "AR-002", "자동화 규칙 기준값이 올바르지 않습니다."),
    INVALID_MIN_SAMPLE_COUNT(400, "AR-003", "자동화 규칙 최소 표본 수가 올바르지 않습니다."),
