...
public record ProblemDatasetUploadResponse(
        ...
        @Schema(description = "브라우저나 코드 실행기가 접근할 수 있는 GCS URL", example = "https://storage.googleapis.com/codebombalms/problem_dataset/28679fde-6075-4c2e-a3f0-190fa3d80db7_employee_performance.csv")
        String fileUrl,

        @Schema(description = "GCS 버킷 내 객체 경로", example = "problem_dataset/28679fde-6075-4c2e-a3f0-190fa3d80db7_employee_performance.csv")
        String filePath,
