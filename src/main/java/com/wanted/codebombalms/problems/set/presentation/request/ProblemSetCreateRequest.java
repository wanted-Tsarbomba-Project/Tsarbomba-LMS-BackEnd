...
public record ProblemSetCreateRequest(
        ...
        @Schema(description = "문제 카테고리명. 등록된 카테고리를 사용합니다.", example = "Python 데이터 분석", requiredMode = Schema.RequiredMode.REQUIRED)
        String categoryName,
        ...
        @Schema(description = "문제 세트에 포함될 소문제 목록. 1개 이상 필요합니다.", requiredMode = Schema.RequiredMode.REQUIRED)
