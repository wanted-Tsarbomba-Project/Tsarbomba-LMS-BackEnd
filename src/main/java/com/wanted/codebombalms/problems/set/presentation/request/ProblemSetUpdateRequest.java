...
public record ProblemSetUpdateRequest(
        ...
        @Schema(description = "문제 카테고리명입니다. 이미 등록된 카테고리를 사용합니다.", example = "Python 데이터 분석")
        String categoryName,
        ...
        @Schema(description = "참고용 데이터 파일명입니다. 실제 데이터셋 연결은 문제 세트 등록/데이터셋 API 흐름을 사용합니다.", example = "employee_performance.csv", nullable = true)
        String dataFileName,

        @Schema(description = "문제 세트에 포함할 소문제 목록입니다.")
